...
public class DuckLangRe {
    ...
    public static void main(String[] args) {
        ...
        NFA singleLineCommentNFA = tc.reToNFA("~QUACK");
        System.out.println("Single-line comment NFA:");
        tc.printNFA(singleLineCommentNFA);
        String input10 = "~QUACK";
        System.out.println("Input '" + input10 + "' matches: " + testNFA(singleLineCommentNFA, input10));
        System.out.println("Single-line comment NFA:");
        NFA reservewords = tc.reToNFA("QUACK_PRINT|QUACK_INPUT");
        tc.printNFA(reservewords);
        String input11 = "QUACK_PRINT";
        System.out.println("Input '" + input10 + "' matches: " + testNFA(reservewords, input11));
    }
}
